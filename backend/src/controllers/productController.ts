...
import { NewProductRequestBody, BaseQuery, searchQueryProducts } from "../types/types.js";
...
export const searchQuery = TryCatch(async (req:Request<{}, {}, {}, searchQueryProducts>, res, next) =>{
    ...
    const [products, filteredProducts] = await Promise.all([
        ProductModel.find(baseQuery).sort(
